...
class Camera2Session implements CameraSession {
    private static final String TAG = "Camera2Sessionnn";
    ...
    private class CaptureSessionCallback extends CameraCaptureSession.StateCallback {
        ...
        public void onConfigured(CameraCaptureSession session) {
            ...
            try {
                ...
                Logging.d(TAG, "==========="+captureRequestBuilder);
//                setZoom(1.4f);
    ...
    public boolean isZoomSupported() {
        ...
        return zObj.hasSupport;
    }

    public void setZoom(float value) {
        try {
            Logging.d(TAG, "00000000000"+captureRequestBuilder);
            Zoom zObj = new Zoom(cameraCharacteristics);
            zObj.setZoom(captureRequestBuilder, value);
            captureRequestBuilder.addTarget(surface);
            captureSession.setRepeatingRequest(
                    captureRequestBuilder.build(), new CameraCaptureCallback(), cameraThreadHandler);
        } catch (Exception e) {
            reportError("ZOOM ERROR : " + e.getMessage());
            return;
        }
    }
    ...
    // TODO: Below methods to be changed according to what camera2 API returns
